...
| Max-min and CVaR MILPs remain feasible across 30 seeded suites | `verified-synthetic` | `decision-benchmark`; 56 tests | Say synthetic operations benchmark only |
...
| 1973–2023 exact-SHA annual pipeline is restartable and quality-gated | `verified-code-and-partial-run` | Year-array/aggregate source and tests; 2020 exact-SHA run completed; 51-year array job `29484660` remains in progress | Describe implemented checkpoint/aggregation controls; do not state that the full array completed until its dependent aggregate exits 0 and passes the completeness gate |
