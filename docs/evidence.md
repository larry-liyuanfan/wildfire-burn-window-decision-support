...
| 1973–2023 exact-SHA annual pipeline is restartable and quality-gated | `verified-real-regional` | Year-array/aggregate source and tests; official-district array `29486334` and aggregate `29486336` completed 51/51 years at SHA `cbc044c`; statewide array `29484660` remains in progress | May state that the Murray Goldfields district chain completed. Do not state that the statewide 51-year chain completed until its dependent aggregate exits 0 |
